...
namespace Assets._Game.Scripts.Entities.Interactions
{
    ...
    public class InteractionDefinition : ScriptableObject
    {
        ...
        {
            public override IInteractionStep Build(IObjectResolver resolver) => new LootItemPickupStep(resolver.Resolve<IGlobalEventBus>(), resolver.Resolve<ItemStackFactory>());
        }
